...
struct NewCategoryView: View {
    ...
    @ObservedObject var viewModel: FinancialViewModel // Hinzufügen der viewModel-Zuordnung
        ...
        ZStack {
            ...
            VStack {
                ...
                Button(action: {
                    ...
                    // Weitere Aktionen zum Speichern hinzufügen
                }) {
                    Text("Speichern")
...
struct NewCategoryView_Previews: PreviewProvider {
    static var previews: some View {
        NewCategoryView(viewModel: FinancialViewModel()) // Übergabe von viewModel
    }
}
